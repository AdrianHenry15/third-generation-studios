  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link href="/contact-us"><Button className="bg-gradient-to-r from-green-600 to-green-800 text-white rounded-xl hover:shadow-[0_0_20px_rgba(34,197,94,0.6)] hover:from-green-500 hover:to-green-700 transition-all duration-300">Get in Touch</Button></Link>
        </div>
      </motion.div>
      )}
    </motion.header>
