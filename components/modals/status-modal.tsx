          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <DialogPanel className="w-full max-w-md transform overflow-hidden rounded-xl bg-white p-8 text-left align-middle shadow-xl transition-all relative">
                ...
                {/* Status icon */}
                <div className={`mx-auto flex h-16 w-16 items-center justify-center rounded-full ${colorScheme.icon.bg} mb-6`}>
                  {isSuccess ? (
                ...
                <DialogTitle
                  as="h3"
                  className="text-center text-xl font-bold leading-6 text-gray-900 mb-2"
                >
                  {title}
                </DialogTitle>
