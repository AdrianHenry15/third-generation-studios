        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-xl text-slate-300 mb-8 leading-relaxed max-w-lg">
              We convert your digital vision into reality with{" "}
              <span className="text-green-400 font-semibold">MVP-ready</span> custom solutions using cutting-edge
              technologies.
            </motion.p>
                ...
                <div className="p-6">
                  <pre className="text-sm text-slate-300 overflow-x-hidden leading-relaxed">
                    <code className="font-mono">
                      ...
                      <span className="text-purple-400">from</span> <span className="text-green-300">'your-ideas'</span>
                      <span className="text-slate-500">;</span>
                      {"\n\n"}
