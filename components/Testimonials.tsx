...
export default function Testimonials() {
    ...
    const testimonials = [
        {
            quote: "Third Generation Studios transformed our concept into a fully functional MVP in record time. Their expertise in cutting-edge technologies helped us secure our first round of funding.",
            author: "Sarah Johnson",
            position: "CEO, TechStart",
            rating: 5,
        },
        {
            quote: "Working with Third Generation Studios was a game-changer for our business. Their AI integration capabilities gave us a competitive edge in our market.",
            author: "Michael Chen",
