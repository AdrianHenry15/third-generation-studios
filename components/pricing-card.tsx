...
const PricingCard = (props: IPricingCardProps) => {
    return (
        <div className="flex flex-col flex-1 relative pb-10 mx-2 bg-white rounded-md shadow-lg shadow-white my-6">
            <div className="flex bg-red-600 rounded-t-md justify-between p-2">
            ...
            <div className="p-4">
                {/* TOP */}
                <span className="text-4xl font-light flex justify-center text-center">{props.description}</span>
                {/* PRICING */}
                <div className="flex items-center my-10">
                    <h2 className="text-2xl font-bold flex mr-2">{`$${props.price}`}</h2>
