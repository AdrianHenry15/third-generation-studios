...
const Plan = (props: IPlanProps) => {
    ...
    return (
        <div
            ...
            }  flex flex-col  m-4 py-4 px-3 rounded-lg flex-1 h-full`}
        >
            <div className="flex flex-col w-full p-2 border-[1px] bg-zinc-400 border-white rounded-lg h-full">
                <h3 className="text-3xl font-semibold text-start">{title}</h3>
                {/* <h3>{title}</h3> */}
