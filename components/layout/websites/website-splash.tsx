...
export default function WebsiteSplash() {
    ...
    return (
        <div className="w-full text-white relative">
            <Swiper modules={[A11y, Autoplay]} centeredSlides slidesPerView={1} autoplay={{ delay: 5000 }} className="w-full">
                    ...
                    <SwiperSlide key={site.id}>
                        ...
                        <div className="relative w-full h-[60vh] md:h-screen">
                            ...
                            >
                                ...
                                <p className="text-gray-300 text-sm sm:text-base md:text-lg mb-4">Published on {site.release_date}</p>
