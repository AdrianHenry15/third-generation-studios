...
const Row = (props: IRowProps) => {
    return (
        <section className="bg-black relative text-white flex flex-col h-min-content p-10">
            ...
            <div className=" w-full h-[275px] overflow-x-auto pb-6 pt-1 my-14">
                <ul className="flex animate-carousel">
                    {props.item.map((project) => (
                        <li key={project.id} className="relative h-[30vh] max-h-[275px] w-2/3 max-w-[450px] flex-none md:w-1/3">
