      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <motion.div variants={itemVariants} className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold gradient-text mb-4">ThirdGenerationStudios</h3>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-4">
                ...
                <a href="mailto:hahenry@thirdgenerationstudios.com" className="text-gray-400 hover:text-green-400 transition-colors">
                  hahenry@thirdgenerationstudios.com
                </a>
                </li>
              <li className="flex items-start">
        ...
        >
          <p>© {new Date().getFullYear()} ThirdGenerationStudios. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  )
