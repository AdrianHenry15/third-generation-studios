    ...
    return (
        <div className="container mx-auto p-4 max-w-6xl">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full z-[1000] lg:w-80 lg:sticky lg:top-4 h-fit bg-white p-6 border rounded order-first lg:order-last fixed bottom-0 left-0 lg:left-auto">
                ...
                <div className="h-64 lg:h-0">{/* Space for fixed checkout on mobile */}</div>
            </div>
        </div>
    );
};
